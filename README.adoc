...
You must specify `send-artifact-info: true` in order to send artifact data to CloudBees Unify.
...
| String
| No
| The name of the artifact to send to CloudBees Unify for artifact traceability purposes.
...
| Boolean
| No
| If `true`, sends artifact information to CloudBees Unify for artifact traceability purposes.
